...
centroids = norm_data[random.sample(range(norm_data.shape[0]), 6)]
...
denorminalisated_data = np.array([re_calc_collisions, re_calc_balls, re_calc_lines, re_calc_teleports, re_calc_fails, re_calc_duration]).T
